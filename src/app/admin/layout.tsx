          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center space-x-3 text-white font-bold text-xl">
                <img src="/piechem-logo.png" alt="PIECHEM Logo" className="h-8 w-auto object-contain" />
                <span className="border-l border-gray-700 pl-3 text-base text-gray-300 font-medium">Admin Panel</span>
              </div>
